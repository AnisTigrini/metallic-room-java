...
public class AccessoireRetourAirTest {
    
    public AccessoireRetourAirTest() {
    }
    
    @Test
    public void testContructeurSansParametre() {
        AccessoireRetourAir accessoire = new AccessoireRetourAir();
        assertEquals(false, accessoire.estTraversant());
        
        assertEquals(8, accessoire.getHauteur().getPartieEntiere());
        assertEquals(0, accessoire.getHauteur().getNumerateur());
        assertEquals(1, accessoire.getHauteur().getDenominateur());
        
        assertEquals(24, accessoire.getLargeur().getPartieEntiere());
    ...
    public void testerCloneAccessoire() {
        try {
            AccessoireRetourAir accessoire = new AccessoireRetourAir();
            AccessoireRetourAir accessoireClone = (AccessoireRetourAir) accessoire.clone();
